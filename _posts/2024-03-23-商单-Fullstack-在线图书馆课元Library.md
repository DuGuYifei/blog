...
image:
 path: ../attachments/2024-03-23-商单-FullStack-在线图书馆课元Library/image.png
...
2. 组织多级管理，鉴权，前端镜像
3. 分类映射时，对 LCC 美国国会图书馆分类和 CLC 中图分类法做了递归匹配。根据分类名称的相似度寻找最接近的中图分类节点，并保留匹配结果和相似度，生成可追溯的 json 映射数据。同时也对中文名称和英文名称列表做了对应关系匹配，方便后续统一分类展示、检索和数据对齐。
...
![alt text](/attachments/2024-03-23-商单-FullStack-在线图书馆课元Library/image-3.png)

## 设计师初稿
![alt text](/attachments/2024-03-23-商单-FullStack-在线图书馆课元Library/image.png)

![alt text](/attachments/2024-03-23-商单-FullStack-在线图书馆课元Library/image-2.png)

![alt text](/attachments/2024-03-23-商单-FullStack-在线图书馆课元Library/image-1.png)
